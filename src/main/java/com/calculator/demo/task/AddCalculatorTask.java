 ...
 * @Description: 相加任务
 */
public class AddCalculatorTask extends AbstractCalculatorTask {
    public AddCalculatorTask() {
        super();
    }
    ...
    public void execute() {
        ...
        BigDecimal res = lastResult.add(this.operands).setScale(scale, BigDecimal.ROUND_HALF_UP);
