 ...
 * @Description: 相减任务
 */
public class SubtractionCalculatorTask extends AbstractCalculatorTask {
    public SubtractionCalculatorTask() {
        super();
    }
    ...
    public void execute() {
        ...
        BigDecimal res = lastResult.subtract(this.operands).setScale(scale, BigDecimal.ROUND_HALF_UP);
